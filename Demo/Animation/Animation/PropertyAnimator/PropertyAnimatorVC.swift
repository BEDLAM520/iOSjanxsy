...
class PropertyAnimatorVC: UITableViewController {

    let cellArray = ["PSimpleMoveVC", "PPanVC", "PPopVC"]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vcString = cellArray[indexPath.row]
        guard let vcClass = classFromString(vcString) as? UIViewController.Type else {
            return
        }
        
        let vc = vcClass.init(nibName: vcString, bundle: nil)
        vc.title = vcString
